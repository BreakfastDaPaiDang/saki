...
来源：[`packages/saki/execution-local/src/agent-run.ts:35`](../packages/saki/execution-local/src/agent-run.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `agentRunId` | 必需 | `string` |
| `kind` | 必需 | `"saki-agent-run-wake"` |
| `ordinal` | 必需 | `number` |
...
来源：[`packages/saki/execution/src/types.ts:678`](../packages/saki/execution/src/types.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `agentRunId` | 必需 | `string` |
| `dispatchId` | 必需 | `string` |
| `kind` | 必需 | `"saki-agent-run"` |
| `workSessionId` | 必需 | `string` |
...
来源：[`packages/saki/execution/src/types.ts:686`](../packages/saki/execution/src/types.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `grantId` | 必需 | `string` |
| `grantRevision` | 必需 | `number` |
| `hostId` | 必需 | `string` |
| `installationId` | 必需 | `string` |
| `principalId` | 必需 | `string` |
| `principalRevision` | 必需 | `number` |
| `storageGenerationId` | 必需 | `string` |
...
来源：[`packages/saki/execution/src/types.ts:697`](../packages/saki/execution/src/types.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `actor` | 必需 | [`packages/saki/execution/src/types.ts#SakiControlIntentActorAttribution`](#persistence-type-packagessakiexecutionsrctypestssakicontrolintentactorattribution) |
| `agentRunId` | 必需 | `string` |
| `answerIntentId` | 必需 | `string` |
| `dispatchId` | 必需 | `string` |
| `interventionId` | 必需 | `string` |
| `kind` | 必需 | `"saki-intervention-answer"` |
| `workSessionId` | 必需 | `string` |
