...
| `event:agent/inbox/spliced` | event | `3bf1f018545e4a456dc441c96fbe30cd396d1068dd3c9aed12f60ef7fa92f66f` | [`event:agent/inbox/spliced`](#persistence-type-eventagentinboxspliced) |
...
| `event:session/title-llm-request` | event | `b7db8b7a915c06cec46b3cbdb97c048a65bdd9aa8e88648d6d9d8ec8ce8710fa` | [`event:session/title-llm-request`](#persistence-type-eventsessiontitle-llm-request) |
...
| `event:user/message` | event | `78da26327c11f64e2c6689e3eb3004e87e7af0524c486429ef173ba67549b2df` | [`event:user/message`](#persistence-type-eventusermessage) |
...
SHA-256: `3bf1f018545e4a456dc441c96fbe30cd396d1068dd3c9aed12f60ef7fa92f66f`
...
SHA-256: `938a1614cfcda9d4545a410fe9c0d7e0c6c2043d32310f22abe5b5096213239d`
...
SHA-256: `8cf8fe4630ed8171bae05a0bd4b0c055ecf2d9b509f9e03e9763041b5bbe1b79`
...
SHA-256: `b7db8b7a915c06cec46b3cbdb97c048a65bdd9aa8e88648d6d9d8ec8ce8710fa`
...
SHA-256: `a498eb11f4e8a7e42b004bdc2ed377529e038bd3571cc4eacc4450e83dfebe7e`
...
SHA-256: `78da26327c11f64e2c6689e3eb3004e87e7af0524c486429ef173ba67549b2df`
...
SHA-256: `56168c68fbad5956e2db46d2a4fcd0a90ecd21ac5766c3afa3b709d1223a8b6c`
...
SHA-256: `e3920f6d009a73edded881ce2cfe88a112fcf3dd7906e722f70a2d36ca1cb60d`

Sources: [`packages/llm/llm/src/message.ts:128`](../packages/llm/llm/src/message.ts)

One of:

- [`packages/saki/execution/src/types.ts#SakiInterventionAnswerMessageSource`](#persistence-type-packagessakiexecutionsrctypestssakiinterventionanswermessagesource)
- [`packages/saki/execution/src/types.ts#SakiAgentRunMessageSource`](#persistence-type-packagessakiexecutionsrctypestssakiagentrunmessagesource)
- [`packages/saki/execution-local/src/agent-run.ts#SakiAgentRunWakeMessageSource`](#persistence-type-packagessakiexecution-localsrcagent-runtssakiagentrunwakemessagesource)
...
SHA-256: `7a2a842c1c1d36c889bc704c0990eb9585c4ccced009a377c0c31364584c4c5f`
...
<a id="persistence-type-packagessakiexecution-localsrcagent-runtssakiagentrunwakemessagesource"></a>

### `packages/saki/execution-local/src/agent-run.ts#SakiAgentRunWakeMessageSource`

SHA-256: `06d1a332e7706d74c25c59af16d5909b82df7d11a2695e565a7ec4f0b699d315`

Sources: [`packages/saki/execution-local/src/agent-run.ts:35`](../packages/saki/execution-local/src/agent-run.ts)

| Property | Presence | Type |
|---|---|---|
| `agentRunId` | required | `string` |
| `kind` | required | `"saki-agent-run-wake"` |
| `ordinal` | required | `number` |

<a id="persistence-type-packagessakiexecutionsrctypestssakiagentrunmessagesource"></a>

### `packages/saki/execution/src/types.ts#SakiAgentRunMessageSource`

SHA-256: `d61c4acabaebe287047d5132398b899872976ed301213b1e1036cc531d86135f`

Sources: [`packages/saki/execution/src/types.ts:678`](../packages/saki/execution/src/types.ts)

| Property | Presence | Type |
|---|---|---|
| `agentRunId` | required | `string` |
| `dispatchId` | required | `string` |
| `kind` | required | `"saki-agent-run"` |
| `workSessionId` | required | `string` |

<a id="persistence-type-packagessakiexecutionsrctypestssakicontrolintentactorattribution"></a>

### `packages/saki/execution/src/types.ts#SakiControlIntentActorAttribution`

SHA-256: `b1fd28c62922b54c4ae6193f2028add88771b4c82cbdaee48861d813ca2fa6fc`

Sources: [`packages/saki/execution/src/types.ts:686`](../packages/saki/execution/src/types.ts)

| Property | Presence | Type |
|---|---|---|
| `grantId` | required | `string` |
| `grantRevision` | required | `number` |
| `hostId` | required | `string` |
| `installationId` | required | `string` |
| `principalId` | required | `string` |
| `principalRevision` | required | `number` |
| `storageGenerationId` | required | `string` |

<a id="persistence-type-packagessakiexecutionsrctypestssakiinterventionanswermessagesource"></a>

### `packages/saki/execution/src/types.ts#SakiInterventionAnswerMessageSource`

SHA-256: `706a672dbe037bc6abbf90364f2a8a5d910ab467707203a9131a8d64f1e114ba`

Sources: [`packages/saki/execution/src/types.ts:697`](../packages/saki/execution/src/types.ts)

| Property | Presence | Type |
|---|---|---|
| `actor` | required | [`packages/saki/execution/src/types.ts#SakiControlIntentActorAttribution`](#persistence-type-packagessakiexecutionsrctypestssakicontrolintentactorattribution) |
| `agentRunId` | required | `string` |
| `answerIntentId` | required | `string` |
| `dispatchId` | required | `string` |
| `interventionId` | required | `string` |
| `kind` | required | `"saki-intervention-answer"` |
| `workSessionId` | required | `string` |
...
SHA-256: `60d08bef7aaca5103b18d488cfefc6c4687cc9985d7dea0dba7f73166af43b7c`
...
<a id="persistence-type-saki-agent-run"></a>

### `"saki-agent-run"`

SHA-256: `c1eacd572b5ea4b162c2c7fa8071596b485bf8c1e323030906e031fc23b2a0c4`

`"saki-agent-run"`

<a id="persistence-type-saki-agent-run-wake"></a>

### `"saki-agent-run-wake"`

SHA-256: `14f6a126d0c920b4aa77103b03b192c05c7bd7e049b6a8c047bd3e3591a8cf09`

`"saki-agent-run-wake"`

<a id="persistence-type-saki-intervention-answer"></a>

### `"saki-intervention-answer"`

SHA-256: `4c378560b9a4c74814c63a5a11f7ee126c3a5084f8720eb5f11615321c1716b7`
...
Sources: [`packages/api/session-controller/src/types.ts:375`](../packages/api/session-controller/src/types.ts) · [`packages/attachment/attachment/src/brand.ts:6`](../packages/attachment/attachment/src/brand.ts) · [`packages/compaction/compaction/src/brand.ts:4`](../packages/compaction/compaction/src/brand.ts) · [`packages/core/session/src/types.ts:19`](../packages/core/session/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:20`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:32`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:8`](../packages/experimental/agent-team/src/types.ts) · [`packages/feedback/message-feedback/src/types.ts:14`](../packages/feedback/message-feedback/src/types.ts) · [`packages/goal/goal/src/types.ts:17`](../packages/goal/goal/src/types.ts) · [`packages/interaction/commands/src/brand.ts:31`](../packages/interaction/commands/src/brand.ts) · [`packages/interaction/user-approval/src/types.ts:17`](../packages/interaction/user-approval/src/types.ts) · [`packages/llm/llm-retry/src/brand.ts:4`](../packages/llm/llm-retry/src/brand.ts) · [`packages/llm/llm/src/brand.ts:16`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:31`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:43`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:67`](../packages/llm/llm/src/brand.ts) · [`packages/saki/execution/src/types.ts:109`](../packages/saki/execution/src/types.ts) · [`packages/saki/execution/src/types.ts:13`](../packages/saki/execution/src/types.ts) · [`packages/saki/execution/src/types.ts:19`](../packages/saki/execution/src/types.ts) · [`packages/saki/execution/src/types.ts:22`](../packages/saki/execution/src/types.ts) · [`packages/saki/execution/src/types.ts:25`](../packages/saki/execution/src/types.ts) · [`packages/saki/execution/src/types.ts:28`](../packages/saki/execution/src/types.ts) · [`packages/saki/execution/src/types.ts:31`](../packages/saki/execution/src/types.ts) · [`packages/saki/execution/src/types.ts:34`](../packages/saki/execution/src/types.ts) · [`packages/saki/execution/src/types.ts:40`](../packages/saki/execution/src/types.ts) · [`packages/saki/execution/src/types.ts:43`](../packages/saki/execution/src/types.ts) · [`packages/schedule/schedule/src/types.ts:10`](../packages/schedule/schedule/src/types.ts) · [`packages/session/session-title/src/index.ts:42`](../packages/session/session-title/src/index.ts) · [`packages/session/session-title/src/types.ts:17`](../packages/session/session-title/src/types.ts) · [`packages/webhook/webhook/src/brand.ts:12`](../packages/webhook/webhook/src/brand.ts) · [`packages/webhook/webhook/src/brand.ts:6`](../packages/webhook/webhook/src/brand.ts) · [`packages/webhook/webhook/src/brand.ts:9`](../packages/webhook/webhook/src/brand.ts) · [`packages/workflow/workflow/src/types.ts:13`](../packages/workflow/workflow/src/types.ts)
