...
The [Saki source import](2026-09-19-saki-message-sources.md) acknowledges three message-source variants already shipped before this history was adopted in the fork. Only its three exact before/after schema digest pairs permit that historical union difference within one version; changed schemas and all subsequent transitions follow the ordinary rules.
