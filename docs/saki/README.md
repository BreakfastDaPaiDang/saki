...
- [Development skill pack](development-skill-pack.md) defines repository discovery, compatibility preflight, pinned source and patch records, and the reviewed update procedure.
