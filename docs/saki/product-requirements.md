...
- The [version 0.1.0 frontend contract](architecture/0.1.0-frontend-contract.md) defines client information and interaction semantics. Low-fidelity prototypes and a reviewed visual direction remain required before frontend implementation Issues are split; neither artifact changes the long-term PRD into a fixed page layout.
