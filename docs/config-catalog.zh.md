...
需要： `tools` · `sessions` · `sakiControlPlane` · `timer`
...
来源：[`packages/storage/storage-domain/src/index.ts:76`](../packages/storage/storage-domain/src/index.ts)
...
来源：[`packages/storage/storage-json/src/index.ts:30`](../packages/storage/storage-json/src/index.ts)
...
来源：[`packages/storage/storage-sqlite/src/index.ts:38`](../packages/storage/storage-sqlite/src/index.ts)
...
来源：[`packages/shell/tool-pwsh-persistent/src/index.ts:471`](../packages/shell/tool-pwsh-persistent/src/index.ts)
...
- `@breakfastdapaidang/saki-execution` — 抽象类 `SakiHostExecution` ([`packages/saki/execution/src/index.ts`](../packages/saki/execution/src/index.ts))
- `@breakfastdapaidang/saki-github` — 抽象类 `SakiGitHub` ([`packages/saki/github/src/index.ts`](../packages/saki/github/src/index.ts))
- `@deepseek-ai/dsh-attachment` — 抽象类 `AttachmentStore` ([`packages/attachment/attachment/src/index.ts`](../packages/attachment/attachment/src/index.ts))
- `@deepseek-ai/dsh-code-runtime` — 抽象类 `CodeRuntime` ([`packages/code-runtime/code-runtime/src/index.ts`](../packages/code-runtime/code-runtime/src/index.ts))
- `@deepseek-ai/dsh-compaction` — 抽象类 `CompactionEngine` ([`packages/compaction/compaction/src/index.ts`](../packages/compaction/compaction/src/index.ts))
- `@deepseek-ai/dsh-credentials` — 抽象类 `CredentialProvider` ([`packages/credentials/credentials/src/index.ts`](../packages/credentials/credentials/src/index.ts))
- `@deepseek-ai/dsh-file-reference` — 抽象类 `FileReferenceService` ([`packages/context/file-reference/src/index.ts`](../packages/context/file-reference/src/index.ts))
- `@deepseek-ai/dsh-fs` — 抽象类 `FileSystem` ([`packages/fs/fs/src/index.ts`](../packages/fs/fs/src/index.ts))
- `@deepseek-ai/dsh-host-directory-picker` — 抽象类 `DirectoryPicker` ([`packages/host/directory-picker/src/index.ts`](../packages/host/directory-picker/src/index.ts))
- `@deepseek-ai/dsh-jobs` — 抽象类 `JobRegistry` ([`packages/jobs/jobs/src/index.ts`](../packages/jobs/jobs/src/index.ts))
- `@deepseek-ai/dsh-sandbox` — 抽象类 `SandboxProvider` ([`packages/sandbox/sandbox/src/index.ts`](../packages/sandbox/sandbox/src/index.ts))
- `@deepseek-ai/dsh-session-persistence` — 抽象类 `SessionPersistence` ([`packages/session/session-persistence/src/index.ts`](../packages/session/session-persistence/src/index.ts))
- `@deepseek-ai/dsh-session-query` — 抽象类 `SessionQueryEngine` ([`packages/session-query/session-query/src/index.ts`](../packages/session-query/session-query/src/index.ts))
- `@deepseek-ai/dsh-settings` — 抽象类 `SettingsProvider` ([`packages/settings/settings/src/index.ts`](../packages/settings/settings/src/index.ts))
- `@deepseek-ai/dsh-shell` — 抽象类 `ShellExecutor` ([`packages/shell/shell/src/index.ts`](../packages/shell/shell/src/index.ts))
- `@deepseek-ai/dsh-spill` — 抽象类 `SpillStore` ([`packages/spill/spill/src/index.ts`](../packages/spill/spill/src/index.ts))
- `@deepseek-ai/dsh-subprocess` — 抽象类 `SubprocessRuntime` ([`packages/subprocess/subprocess/src/index.ts`](../packages/subprocess/subprocess/src/index.ts))
- `@deepseek-ai/dsh-workflow` — 抽象类 `WorkflowEngine` ([`packages/workflow/workflow/src/index.ts`](../packages/workflow/workflow/src/index.ts))
