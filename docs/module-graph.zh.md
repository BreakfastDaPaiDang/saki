...
flowchart TD
  ...
  pkg_saki_tool_intervention --> pkg_tools
  ...
  pkg_saki_execution_local --> pkg_agent
  ...
  pkg_saki_execution_local --> pkg_session_persistence
  pkg_saki_execution_local --> pkg_storage_domain
  pkg_saki_execution_local --> pkg_subprocess
  pkg_saki_execution_local --> pkg_terminal
...
| [`saki/execution-local`](../packages/saki/execution-local) | `saki` | [`agent`](../packages/core/agent), [`agent-presets`](../packages/preset/agent-presets), [`fs`](../packages/fs/fs), [`fs-local`](../packages/fs/fs-local), [`llm`](../packages/llm/llm), [`saki/execution`](../packages/saki/execution), [`session`](../packages/core/session), [`session-persistence`](../packages/session/session-persistence), [`storage-domain`](../packages/storage/storage-domain), [`subprocess`](../packages/subprocess/subprocess), [`terminal`](../packages/terminal/terminal), [`timeout`](../packages/util/timeout), [`workspace`](../packages/workspace/workspace) |
