...
Candidates from the previous query remain visible while their replacement loads, but carry `aria-disabled="true"` and cannot be picked. They become available when their source finishes the current query.
