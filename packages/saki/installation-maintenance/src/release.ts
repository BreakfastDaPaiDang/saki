/**
 * Fixed Saki build provenance used by the B18 maintenance and serving launchers.
...
/** Provenance for generations created by this B18 source build. */
export const CURRENT_SAKI_BUILD_ID = sakiBuildIdSchema.parse('saki-build-0.1.0-b18')
