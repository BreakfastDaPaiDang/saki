...
| `maxItems` | 20,000 | 1–100,000 | 每个集合接纳的 Project item、open scan Issue、PR association、精确 PR review、精确 Commit CI fact、Milestone Issue 或 create-inspection entry 数量；它不限制 installation Repository 或 Project field。Actions workflow 与 check endpoint 还保留 GitHub 的 1,000 项上限。 |
