...
- **Early Project lifecycle only** — the Host supports local access, existing-directory inspection, initial Development Project registration, the Project index, and the Development Workspace. Resource Binding rebind and retirement, Agents, model providers, and rendered Web surfaces are not composed.
