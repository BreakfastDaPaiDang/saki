...
export class LocalSubprocessRuntime extends SubprocessRuntime {
  ...
  /**
   * Select the process owner before spawning a target.
   * @param kind - ordinary process or terminal allocation.
   * @returns supported native ownership or the platform fallback.
   */
  protected selectContainmentMode(
