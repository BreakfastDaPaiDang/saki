...
Fixture providers can override the protected `selectContainmentMode` method to select platform fallback ownership while inheriting handle tracking, disposal, and host-exit cleanup. Saki real-Git behavior tests use that selection; GitRunner and assembled Saki tests exercise native ownership.
