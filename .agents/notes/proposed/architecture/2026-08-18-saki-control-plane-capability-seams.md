...
The implemented [existing-directory Project registration](../../implemented/architecture/2026-08-20-saki-existing-directory-project-registration.md) supplies the read-only Host Execution definition, its Local Host Provider, and the first control-plane Consumer operation. The implemented [polling-first GitHub synchronization](../../implemented/architecture/2026-08-18-saki-polling-first-github-synchronization.md) supplies the GitHub Service Definition, Product App Provider, recoverable polling Consumer, synchronization configuration, and read-only Board Projection. Its mutation declaration remains empty. This note remains proposed because Host mutation operations, GitHub writes and mapping repair, and the Model Account and Image Generation seams are not implemented.
