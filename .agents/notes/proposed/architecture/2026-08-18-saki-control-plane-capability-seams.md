...
The implemented [existing-directory Project registration](../../implemented/architecture/2026-08-20-saki-existing-directory-project-registration.md) supplies the read-only Host Execution definition, its Local Host Provider, and the first control-plane Consumer operation. This note remains proposed because the Host mutation operations and the GitHub, Model Account, and Image Generation seams are not implemented.
