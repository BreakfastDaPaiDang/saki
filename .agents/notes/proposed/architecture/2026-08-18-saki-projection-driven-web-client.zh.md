...
已实现的 [Shell 登记](../../implemented/feature/2026-08-27-saki-web-shell-registration.zh.md)、[确认规划视图](../../implemented/feature/2026-09-10-saki-confirmed-planning-views.zh.md)、[手动 Work 交互](../../implemented/feature/2026-09-10-saki-manual-work-interactions.zh.md)及 [Run 观察](../../implemented/feature/2026-09-14-saki-read-only-run-observation.zh.md)拥有各自已交付机制。本提案保留自动 Work、Settings、协调者集成及更广泛恢复范围。
...
已实现的 [GUI 分层与 RPC](../../archived/architecture/2026-07-19-gui-layering-and-rpc-protocol.md)以及 [Web 客户端架构](../../implemented/architecture/2026-07-19-gui-web-client-architecture.zh.md)决定继续拥有本提案扩展的通用客户端机制。已拒绝的[动态客户端 package 提案](../../rejected/architecture/2026-08-08-cordis-web-dynamic-packages.zh.md)不构成 loader 前提；Saki 使用已发布 plugin 路径。
