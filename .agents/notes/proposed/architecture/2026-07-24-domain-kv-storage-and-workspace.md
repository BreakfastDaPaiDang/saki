...
| Data migration | a durable consumer promises compatibility across versions | opt-in version-driven per-domain migration through the [Saki migration proposal](2026-08-18-saki-forward-migrations-and-installation-maintenance.md) | versions are on the medium from day one; domains without a complete chain still fail loud |
