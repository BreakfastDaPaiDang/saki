...
`SakiWorkItemDetailProjection` and `SakiAgentRunProjection` provide safe fixture contracts. The queryable Work Item view joins current Issue and execution evidence; [Run observation](2026-09-14-saki-read-only-run-observation.md) separately projects retained Sessions, Dispatch delivery and physical DSH outcomes without granting execution authority.
