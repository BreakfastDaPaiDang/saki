...
hook 预算跟随 `DSH_COVERAGE_TEST_TIMEOUT_MS`；不设置它的 lane 保持 Vitest 默认值，包括 10 秒的 hook 预算。[Saki Actions 成本策略](../process/2026-08-18-saki-actions-cost-policy.zh.md) 拥有 Windows 诊断的运行范围与触发方式。
