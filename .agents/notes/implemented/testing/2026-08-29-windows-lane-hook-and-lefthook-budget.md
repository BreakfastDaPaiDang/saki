...
The hook budget follows `DSH_COVERAGE_TEST_TIMEOUT_MS`; lanes that leave it unset retain Vitest defaults, including the 10 s hook budget. [Saki Actions cost policy](../process/2026-08-18-saki-actions-cost-policy.md) owns which Windows diagnostics run and their triggers.
