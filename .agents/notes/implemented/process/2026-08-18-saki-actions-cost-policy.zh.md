...
这项 Saki 专属策略仅取代继承的[文档投影](2026-07-13-documentation-site-projection.md)、[串行参考流程](2026-07-21-serial-cross-platform-ci-reference.md)、[大型运行器测量](2026-07-22-evidence-based-larger-hosted-runners.md)、[本地钩子](2026-07-22-fast-local-git-hooks.md)、[可移植 PR CI](2026-07-23-portable-required-pull-request-ci.md)、[已归档的 CI 故障切换](../../archived/process/2026-07-26-ci-failover-runbook.md)、[pnpm 缓存](2026-07-26-pnpm-action-setup-for-symmetric-ci-caching.md)、[原生 Windows](2026-08-08-native-windows-pull-request-ci.md)、[npm 发布](2026-08-10-npm-release-sequences.md)、[Landlock 发布](2026-08-06-in-repository-landlock-release.md)、[基于属性的测试](../testing/2026-06-11-property-based-testing.md)、[浏览器 GUI 车道](../testing/2026-07-24-web-gui-browser-e2e-lane.md)、[浏览器快照 CI](../testing/2026-07-30-web-browser-snapshot-ci-gate.md)、[已归档的真实 API 自动化](../../archived/testing/2026-06-19-real-api-e2e-ci.md)与[Python 运行时](../testing/2026-08-12-required-python-runtime-pull-request-ci.md)决策中的触发频率、运行器分配和缓存生产方结论。工作流仍在使用的测试约定、发布机制、测量结果与安全分析继续适用。
