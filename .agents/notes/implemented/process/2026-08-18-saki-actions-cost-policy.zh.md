...
[自动审阅人路由](../../../../.github/workflows/request-review.yml)仅在 `deepseek-ai/deepseek-harness` 中运行。其归属文件列出的是上游维护者，因此 Saki 不得向他们请求审阅或修改其审阅指派。[weighted-approval 发布器](../../../../.github/workflows/weighted-approval.yml)及其 [review-event 记录器](../../../../.github/workflows/weighted-approval-review-event.yml)具有相同的仓库限制；上游 reviewer 权重不支配 Saki 合并。
