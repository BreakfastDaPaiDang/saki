...
The [Saki runtime integration](../architecture/2026-09-06-saki-upstream-runtime-integration.md) retains five hash-sealed skill replay artifacts as captured evidence. Only their exact recorded bytes are exempt; edited content and new recordings remain checked.
