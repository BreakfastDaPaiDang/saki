...
Manual native Windows diagnostics in [ci.yml](../../../../.github/workflows/ci.yml) branch on the workspace filesystem, using clone only on ReFS. The [Saki Actions cost policy](2026-08-18-saki-actions-cost-policy.md) owns runner allocation and excludes the upstream master standby:
