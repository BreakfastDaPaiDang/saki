...
Humans and Agents share one durable Work Item lifecycle and one routing vocabulary. Board implementations must project GitHub Issue state instead of owning a second copy, and every new domain context must register through the context map.
