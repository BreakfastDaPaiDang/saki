...
Saki 采用本历史机制时保留此前已发行的消息来源扩展。[摘要封存的导入记录](../../../../docs/persistence-changes/2026-09-19-saki-message-sources.zh.md) 指定三个精确的前后 schema 摘要对，保留上游记录与已发行的 Session 版本。例外仅适用于这些已捕获的联合类型差异；后续扩展与改变后的载荷仍受通常版本要求约束。
