...
Saki adopts this history with its previously shipped message-source extensions intact. The [sealed import](../../../../docs/persistence-changes/2026-09-19-saki-message-sources.md) names three exact before/after schema digest pairs, preserving upstream records and the released Session version. Its exception applies only to those captured union differences; later extensions and changed payloads retain the ordinary version requirements.
