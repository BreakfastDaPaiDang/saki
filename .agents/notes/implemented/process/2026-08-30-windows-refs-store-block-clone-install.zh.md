...
[ci.yml](../../../../.github/workflows/ci.yml) 的手动原生 Windows 诊断按工作区文件系统分支，仅在 ReFS 上使用 clone。[Saki Actions 成本策略](2026-08-18-saki-actions-cost-policy.zh.md) 拥有 runner 分配，并排除上游 master 备用 lane：
