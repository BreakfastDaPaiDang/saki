...
本决定只实现更广的[控制面能力 seam](../../proposed/architecture/2026-08-18-saki-control-plane-capability-seams.zh.md)、[稳定 Resource Binding](../../proposed/architecture/2026-08-18-saki-stable-resource-bindings.zh.md)与[可恢复 Control Intent](../../proposed/architecture/2026-08-18-saki-recoverable-control-intents.zh.md)提案中的 Host 检查与首次登记子集。独立的[polling-first GitHub 同步](2026-08-18-saki-polling-first-github-synchronization.zh.md)已实现只读 GitHub 切片，而[结构化 Git 决策](2026-08-28-saki-recoverable-structured-git-operations.zh.md)以已绑定状态、有界 Diff、直接 mutation 与持久 Host Operation 扩展 Host Execution。这些更广泛的 Agent Note 保持 proposed，因为 GitHub write、Model Account 与 Image Generation 能力 seam、重绑定、退役、repair、Execution Lease、后继 Session、automated dispatch、补偿和其他 Intent 家族尚未实现。
