...
The bundle contains local identity and access plus the existing-directory inspection and first Project-registration slice. It still has no GitHub, Agent, model, or rendered Web behavior. Each later slice decides whether it owns reusable Harness capability in a DSH group or Saki product semantics under `packages/saki/`; neither the accepted architecture nor a planned package name creates a package by itself.
