...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  sakiControlPlane: 'saki.md',
  sakiGitHub: 'saki.md',
  sakiHostExecution: 'saki.md',
  sakiInstallationState: 'saki.md',
  ssh: 'ssh.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  sakiHostClient: 'client-side interface-typed Saki access and Projection service — packages/saki/host-api/README.md owns the API',
  sakiReadiness: 'not a capability service: immutable composition-readiness record — packages/saki/bundle/README.md owns the launcher contract',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SandboxPolicy: 'sandbox.md',
  SakiAuthenticationContext: 'saki.md',
  SakiChangedDisposer: 'saki.md',
  SakiInstallationIdentity: 'saki.md',
  SakiIntent: 'saki.md',
  SakiIntentInput: 'saki.md',
  SakiIntentReceipt: 'saki.md',
  SakiProjectionKey: 'saki.md',
  SakiQuery: 'saki.md',
  SakiQueryMap: 'saki.md',
  ...
  KvUnitSnapshot: 'storage.md',
  Domain: 'storage.md',
  DomainSpec: 'storage.md',
  DomainChanged: 'storage.md',
  DomainFacility: 'storage.md',
  DomainMigrationOptions: 'storage.md',
  DomainMigrationPlan: 'storage.md',
  DomainMigrationResult: 'storage.md',
  DomainMaterializationOptions: 'storage.md',
  DomainMaterializationResult: 'storage.md',
  ActiveHostProjectBinding: 'saki.md',
  HostOperationAcceptance: 'saki.md',
  HostOperationAdmissionSource: 'saki.md',
  HostOperationCancellationReason: 'saki.md',
  HostOperationChange: 'saki.md',
  HostOperationChangedDisposer: 'saki.md',
  HostOperationKind: 'saki.md',
  HostOperationReceipt: 'saki.md',
  HostOperationReference: 'saki.md',
  HostOperationRequest: 'saki.md',
  HostOperationSnapshot: 'saki.md',
  HostOperationStartResult: 'saki.md',
  InspectInterventionOpeningRequest: 'saki.md',
  InterventionOpeningEvidence: 'saki.md',
  AgentRunObservation: 'saki.md',
  AgentRunTerminalSelection: 'saki.md',
