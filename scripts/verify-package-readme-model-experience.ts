...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/saki/web-ui': { kind: 'indirect', reason: 'Explicit Work gestures dispatch Host Intents; the Agent runtime owns their logged Session input.' },
  ...
  'packages/credentials/credentials-windows-dpapi': { kind: 'indirect', reason: 'The Windows ciphertext provider stores credential values; consumers of ctx.credentials own any model-facing behavior.' },
