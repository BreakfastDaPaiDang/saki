...
# The dated snapshot retains the package when the live archive replaces a revision.
...
readonly BUBBLEWRAP_URL="https://snapshot.ubuntu.com/ubuntu/20260919T000000Z/pool/main/b/bubblewrap/bubblewrap_${BUBBLEWRAP_VERSION}_amd64.deb"
