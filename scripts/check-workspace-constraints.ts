...
const packageFileExtras: Readonly<Record<string, readonly string[]>> = {
  ...
  // Providers share the serializer-safe credential snapshot entry.
  ...
  // The private Saki bundle ships its launcher entry, empty root composition,
  // and owned Agent preset beside the patch layer.
  '@breakfastdapaidang/saki-bundle': ['lib/launcher.js', 'cordis.yml', 'config/agent-presets/**/*.yml'],
}
...
export function checkWorkspaceManifest({ dir, manifest }: WorkspaceManifest): string[] {
  ...
  } else if (isReleaseMemberDirectory(dir) && !isPrivateSakiPackage) {
